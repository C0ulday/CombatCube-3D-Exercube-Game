...
{
    [Serializable]
    public struct MinMaxRange : IComparable, IComparable<MinMaxRange>, IEquatable<MinMaxRange>, IStructuralComparable, IStructuralEquatable
    {
        ...
        /// <summary>
        /// Implicitly casting of a <see cref="KoboldTools.MinMaxIntRange" instance.
        /// </summary>
        /// <param name="instance">The convertable instance.</param>
        public static implicit operator MinMaxRange(MinMaxIntRange instance)
        {
        ...
        public int CompareTo(object obj)
        {
            ...
            return CompareTo((MinMaxRange)obj);
        }
        ...
        /// <returns>A value that indicates the relative order of the objects being compared.</returns>
        public int CompareTo(MinMaxRange other)
        {
            float diff = max - min;
        ...
        public int CompareTo(object other, IComparer comparer)
        {
            ...
            MinMaxRange otherRange = (MinMaxRange)other;
