namespace Koboldgames.Primitives.Variables
{
    ...
    [Serializable]
    public sealed class FlexibleVector3Int : FlexibleVariableBase<Vector3Int, SharedVector3IntBase>
    {
        public FlexibleVector3Int(Vector3Int localValue = default(Vector3Int))
        {
        ...
        /// </returns>
        public override int CompareTo(Vector3Int other) => Value.magnitude.CompareTo(other.magnitude);
        ...
        public override bool Equals(Vector3Int other) => Value.Equals(other);
