namespace Koboldgames.Primitives.Variables
{
    ...
    [Serializable]
    public sealed class FlexibleVector3 : FlexibleVariableBase<Vector3, SharedVector3Base>
    {
        public FlexibleVector3(Vector3 localValue = default(Vector3))
        {
        ...
        /// </returns>
        public override int CompareTo(Vector3 other) => Value.magnitude.CompareTo(other.magnitude);
        ...
        public override bool Equals(Vector3 other) => Value.Equals(other);
