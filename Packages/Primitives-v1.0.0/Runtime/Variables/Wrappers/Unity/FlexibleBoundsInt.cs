namespace Koboldgames.Primitives.Variables
{
    ...
    [Serializable]
    public sealed class FlexibleBoundsInt : FlexibleVariableBase<BoundsInt, SharedBoundsIntBase>
    {
        public FlexibleBoundsInt(BoundsInt localValue = default(BoundsInt))
        {
        ...
        private int GetVolume(BoundsInt bounds) => bounds.size.x * bounds.size.y * bounds.size.z;
