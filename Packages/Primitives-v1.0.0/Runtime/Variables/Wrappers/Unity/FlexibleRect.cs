namespace Koboldgames.Primitives.Variables
{
    ...
    [Serializable]
    public sealed class FlexibleRect : FlexibleVariableBase<Rect, SharedRectBase>
    {
        public FlexibleRect(Rect localValue = default(Rect))
        {
        ...
        private float GetArea(Rect rect) => rect.width * rect.height;
