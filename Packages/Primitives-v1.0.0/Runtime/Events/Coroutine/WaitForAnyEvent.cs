namespace Koboldgames.Primitives.Events
{
    ...
    public class WaitForAnyEvent : CustomYieldInstruction
    {
        ...
        /// <summary>
        /// Wait for any basic events to fire.
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAnyEvent(params UnityEvent[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAnyEvent(float timeout, params UnityEvent[] invokers)
        {
            if(invokers == null)
        ...
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAnyEvent(params SharedEvent[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="timeout">The time after which this instruction should timeout.</param>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAnyEvent(float timeout, params SharedEvent[] invokers)
        {
            if(invokers == null)
                throw new ArgumentNullException(nameof(invokers));
