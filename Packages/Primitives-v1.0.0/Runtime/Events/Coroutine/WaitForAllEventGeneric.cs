namespace Koboldgames.Primitives.Events
{
    ...
    public class WaitForAllEvent<T> : CustomYieldInstruction
    {
        ...
        public WaitForAllEvent(params UnityEvent<T>[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(float timeout, params UnityEvent<T>[] invokers)
        {
            if(invokers == null)
        ...
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(params SharedEvent<T>[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="timeout">The time after which this instruction should timeout.</param>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(float timeout, params SharedEvent<T>[] invokers)
        {
            if(invokers == null)
                throw new ArgumentNullException(nameof(invokers));
    ...
    public class WaitForAllEvent<T0, T1> : CustomYieldInstruction
    {
        protected bool[] eventsFired;
        protected Delegate[] reset;
        protected float startTime;
        ...
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(params UnityEvent<T0, T1>[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="timeout">The time after which this instruction should timeout.</param>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(float timeout, params UnityEvent<T0, T1>[] invokers)
        {
            if(invokers == null)
                throw new ArgumentNullException(nameof(invokers));
        ...
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(params SharedEvent<T0, T1>[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="timeout">The time after which this instruction should timeout.</param>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(float timeout, params SharedEvent<T0, T1>[] invokers)
        {
            if(invokers == null)
                throw new ArgumentNullException(nameof(invokers));
    ...
    public class WaitForAllEvent<T0, T1, T2> : CustomYieldInstruction
    {
        protected bool[] eventsFired;
        protected Delegate[] reset;
        protected float startTime;
        ...
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(params UnityEvent<T0, T1, T2>[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="timeout">The time after which this instruction should timeout.</param>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(float timeout, params UnityEvent<T0, T1, T2>[] invokers)
        {
            if(invokers == null)
                throw new ArgumentNullException(nameof(invokers));
        ...
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(params SharedEvent<T0, T1, T2>[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="timeout">The time after which this instruction should timeout.</param>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(float timeout, params SharedEvent<T0, T1, T2>[] invokers)
        {
            if(invokers == null)
                throw new ArgumentNullException(nameof(invokers));
    ...
    public class WaitForAllEvent<T0, T1, T2, T3> : CustomYieldInstruction
    {
        protected bool[] eventsFired;
        protected Delegate[] reset;
        protected float startTime;
        ...
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(params UnityEvent<T0, T1, T2, T3>[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="timeout">The time after which this instruction should timeout.</param>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(float timeout, params UnityEvent<T0, T1, T2, T3>[] invokers)
        {
            if(invokers == null)
                throw new ArgumentNullException(nameof(invokers));
        ...
        /// </summary>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(params SharedEvent<T0, T1, T2, T3>[] invokers) : this(Single.MaxValue, invokers) { }
        ...
        /// <param name="timeout">The time after which this instruction should timeout.</param>
        /// <param name="invokers">The events to be listened on.</param>
        public WaitForAllEvent(float timeout, params SharedEvent<T0, T1, T2, T3>[] invokers)
        {
            if(invokers == null)
                throw new ArgumentNullException(nameof(invokers));
